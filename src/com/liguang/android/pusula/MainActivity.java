package com.liguang.android.pusula;
...
public class MainActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if(item.getItemId() == R.id.menu_settings){
			...
			about.setTitle("Free Compass By Li Guang");
			about.show();
		}
	...
	private void updateLocation(Location location) {
		...
		if (location == null) {
			locationOutput.setText("GPS konumu bulunamadı.");
			return;
		}
...
//			sensorOutput.setText("No sensor data yet...");
		...
		if (DEBUG)
			Log.d(TAG, String.format("Pusulanın yönü değişti: %.2f, %.2f",
					lastDegrees, event.values[0]));
